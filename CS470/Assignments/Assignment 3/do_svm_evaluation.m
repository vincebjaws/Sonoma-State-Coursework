...
%%% compute roc
[roc_curve_test,roc_op_test,roc_area_test,roc_threshold_test] = roc([scorePos';labels]');
fprintf('Testing: Area under ROC curve = %f\n', roc_area_test);
%%% compute rpc
[rpc_curve_test,rpc_ap_test,rpc_area_test,rpc_threshold_test] = recall_precision_curve([scorePos';labels]',length(pos_ip_file_names));
...
%%        end
        ...
        if (Plot.Labels)
            ...
            imageIndex = Categories.All_Test_Frames(index);
